...
CREATE TABLE IF NOT EXISTS `etiapt`.`apt_references` (
  ...
  `apt_group_techniques_techniques_id` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL DEFAULT '0',
  `procedure_example_procedure_eample_id` VARCHAR(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`reference_id`, `apt_group_techniques_techniques_id`, `procedure_example_procedure_eample_id`),
